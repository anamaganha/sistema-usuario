...
<a href="./cadastro.php" class="acoes ripple ripple-jquery" style="text-decoration: none;text-align: center;display: flex;justify-content: center;width: 120px;align-items: center;text-align: center;margin: auto;" data-ripple-color="#FFF">Adicionar</a>
</div>
...
<svg xmlns="http://www.w3.org/2000/svg" width="0" height="0" display="none">
  ...
  <table id="table" class="table table-hover table-mc-light-blue">
      ...
      while($row = mysqli_fetch_array($result, 1)){
        echo '<tr>'.
        '<td data-title="Name">'.$row['nome'].'</td>'.
        '<td data-title="Link" class="acoes-content">'.
          '<div class="content">'.
                '<a href="" class="acoes ripple ripple-jquery" onclick="return editUser('.$row['id'].')" data-ripple-color="#FFF">Editar</a>'.
                '<a href="" class="acoes ripple ripple-jquery" onclick="deleteUser('.$row['id'].')" data-ripple-color="#FFF">Excluir</a>'.
          '</div>'.
        '</td>'.
      '</tr>';
      }
